...
},{"backbone":2,"jquery":4,"jquery-minicolors":3,"underscore":5}],2:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.1
...
describe('ArrayColors', function() {
  beforeEach(function() {
    return this.colors = new Yacp.ColorsArray;
  });
  afterEach(function() {
    return this.colors.remove();
  });
  it('use default colors array', function() {
    return expect(this.colors.colors).to.equal(Yacp.prototype.defaultColors);
  });
...
describe('Yacp', function() {
  ...
  it('first list is default palette', function() {
    this.yacp.render();
    return expect(this.yacp.$('ul').first().find('a')).to.have.length(Yacp.prototype.defaultColors.length);
  });
...
describe('Yacp input', function() {
  beforeEach(function() {
    this.$el = $(tplInput());
    this.users = [];
    return this.yacp = new Yacp.Input({
      el: this.$el,
      users: this.users,
...
},{"backbone":2,"backbone.yacp":1,"jquery":4,"underscore":5}]},{},[6]);
